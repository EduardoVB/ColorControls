...
Private Sub Do_SPANISH(ByRef TextID As Long, ByRef Text As String)
    ...
    Select Case TextID
        Case cdUIT_frmColorDialog_Form_Caption ' English: "Color selection"
            Text = "Selecciσn de color"
        Case cdUIT_ColorSelector_chkFixedPalette_Caption ' English: "Fixed"
            Text = "Fija"
        Case cdUIT_ColorSelector_chkFixedPalette_ToolTipText ' English: "Reflects color changes visually in the palette or not"
            Text = "Refleja o no los cambios de colores en la paleta"
        Case cdUIT_ColorSelector_cboSliderParameter_ToolTipText ' English: "Slider control parameter"
            Text = "Parαmetro del control deslizante"
        Case cdUIT_ColorSelector_lblMode_Caption ' English: "Mode:"
            Text = "Modo:"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Hue ' English: "Hue"
            Text = "Matiz"
        ...
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipEnd ' English: "with the mouse wheel, press Shift key to go slowly"
            Text = "con la rueda del mouse, presione la tecla Mayϊsculas para ir lento"
        Case cdUIT_frmColorDialog_EyeDropper_ToolTip ' English: "Choose a color from anywhere on the screen or press the Escape key to cancel"
...
Private Sub Do_FRENCH(ByRef TextID As Long, ByRef Text As String)
    Select Case TextID
        Case cdUIT_frmColorDialog_Form_Caption ' English: "Color selection"
            Text = "Sιlection couleur"
        Case cdUIT_ColorSelector_chkFixedPalette_Caption ' English: "Fixed"
            Text = "Fixe"
        Case cdUIT_ColorSelector_chkFixedPalette_ToolTipText ' English: "Reflects color changes visually in the palette or not"
            Text = "Reflθte visuellement les changements de couleur dans la palette ou non"
        Case cdUIT_ColorSelector_cboSliderParameter_ToolTipText ' English: "Slider control parameter"
            Text = "Paramθtre du control ascenseur"
        Case cdUIT_ColorSelector_lblMode_Caption ' English: "Mode:"
            Text = "Mode:"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Hue ' English: "Hue"
            Text = "Hue"
        ...
        Case cdUIT_frmColorDialog_ColorPrevious_Caption ' English: "previous"
            Text = "prιcιdente"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipStart ' English: "Hold down the Control key to navigate"
            Text = "Maintenez la touche Control appuyιe pour naviguer"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipEnd ' English: "with the mouse wheel, press Shift key to go slowly"
            Text = "avec la molette de la souris, pressez Shift pour defiler doucement"
        Case cdUIT_frmColorDialog_EyeDropper_ToolTip ' English: "Choose a color from anywhere on the screen or press the Escape key to cancel"
            Text = "Choisir une couleur n'importe-oω ΰ l'ιcran ou presser Ιchap pour annuler"
        Case cdUIT_frmColorDialog_picEyeDropper_ToolTipText ' English: "Choose a color from the screen"
            Text = "Choisir une couleur sur l'ιcran"
        Case cdUIT_frmColorDialog_lblRed_Caption ' English: "Red:"
            Text = "Rouge:"
        Case cdUIT_frmColorDialog_lblGreen_Caption ' English: "Green:"
            Text = "Vert:"
...
Private Sub Do_CHINESE_SIMPLIFIED(ByRef TextID As Long, ByRef Text As String)
    ...
    Select Case TextID
        Case cdUIT_frmColorDialog_Form_Caption ' English: "Color selection"
            Text = StrFromArray(156, 152, 114, 130, 9, 144, 233, 98) ' ANSI: "ΡΥΙ«Ρ΅Τρ"
        Case cdUIT_ColorSelector_chkFixedPalette_Caption ' English: "Fixed"
            Text = StrFromArray(250, 86, 154, 91) ' ANSI: "ΉΜ¶¨"
        Case cdUIT_ColorSelector_chkFixedPalette_ToolTipText ' English: "Reflects color changes visually in the palette or not"
            Text = StrFromArray(47, 102, 38, 84, 40, 87, 3, 140, 114, 130, 127, 103, 45, 78, 244, 118, 194, 137, 48, 87, 205, 83, 32, 102, 156, 152, 114, 130, 216, 83, 22, 83) ' ANSI: "ΚΗ·ρΤΪµχΙ«°εΦΠΦ±ΉΫµΨ·΄Σ³ΡΥΙ«±δ»―"
        Case cdUIT_ColorSelector_cboSliderParameter_ToolTipText ' English: "Slider control parameter"
            Text = StrFromArray(209, 110, 87, 87, 167, 99, 246, 78, 132, 118, 194, 83, 112, 101) ' ANSI: "»¬ΏιΏΨΌώµΔ²ΞΚύ"
        Case cdUIT_ColorSelector_lblMode_Caption ' English: "Mode:"
            Text = StrFromArray(33, 106, 15, 95) ' ANSI: "Δ£Κ½"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Hue ' English: "Hue"
            Text = StrFromArray(114, 130, 3, 140) ' ANSI: "Ι«µχ"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Luminance ' English: "Lum."
            Text = StrFromArray(174, 78, 166, 94) ' ANSI: "ΑΑ¶Θ"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Value ' English: "Value"
            Text = StrFromArray(60, 80) ' ANSI: "Φµ"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Saturation ' English: "Sat."
            Text = StrFromArray(113, 153, 140, 84, 166, 94) ' ANSI: "±¥ΊΝ¶Θ"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Red ' English: "Red"
            Text = StrFromArray(162, 126, 114, 130) ' ANSI: "ΊμΙ«"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Green ' English: "Green"
            Text = StrFromArray(255, 126, 114, 130) ' ANSI: "ΒΜΙ«"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Blue ' English: "Blue"
            Text = StrFromArray(221, 132, 114, 130) ' ANSI: "ΐ¶Ι«"
        Case cdUIT_ColorSelector_cboColorSystem_ListItem_HSV ' English: "HSV"
            Text = "HSV"
        Case cdUIT_ColorSelector_cboColorSystem_ListItem_HSL ' English: "HSL"
            Text = "HSL"
        Case cdUIT_frmColorDialog_lblBasicColors_Caption ' English: "Basic colors:"
            Text = StrFromArray(250, 87, 44, 103, 156, 152, 114, 130, 58, 0) ' ANSI: "»ω±ΎΡΥΙ«:"
        Case cdUIT_frmColorDialog_lblRecent_Caption ' English: "Recent:"
            Text = StrFromArray(0, 103, 209, 143, 58, 0) ' ANSI: "Χξ½ό:"
        Case cdUIT_frmColorDialog_Color_Caption ' English: "color"
            Text = StrFromArray(156, 152, 114, 130) ' ANSI: "ΡΥΙ«"
        Case cdUIT_frmColorDialog_ColorNew_Caption ' English: "new"
            Text = StrFromArray(176, 101, 250, 94) ' ANSI: "ΠΒ½¨"
        Case cdUIT_frmColorDialog_ColorPrevious_Caption ' English: "previous"
            Text = StrFromArray(10, 78, 0, 78, 42, 78) ' ANSI: "ΙΟÒ»Έφ"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipStart ' English: "Hold down the Control key to navigate"
            Text = StrFromArray(9, 99, 79, 79, 32, 0, 67, 0, 116, 0, 114, 0, 108, 0, 32, 0, 46, 149, 219, 143, 76, 136, 252, 91, 42, 130) ' ANSI: "°΄Χ΅ Ctrl Όό½ψΠΠµΌΊ½"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipEnd ' English: "with the mouse wheel, press Shift key to go slowly"
            Text = StrFromArray(127, 79, 40, 117, 32, 159, 7, 104, 218, 110, 110, 143, 22, 98, 9, 99, 32, 0, 83, 0, 104, 0, 105, 0, 102, 0, 116, 0, 32, 0, 46, 149, 19, 127, 98, 97, 251, 121, 168, 82) ' ANSI: "ΚΉΣΓΚσ±κΉφΒΦ»ς°΄ Shift Όό»ΊΒύÒΖ¶―"
        Case cdUIT_frmColorDialog_EyeDropper_ToolTip ' English: "Choose a color from anywhere on the screen or press the Escape key to cancel"
            Text = StrFromArray(206, 78, 79, 92, 85, 94, 10, 78, 132, 118, 251, 78, 15, 97, 77, 79, 110, 127, 9, 144, 233, 98, 0, 78, 205, 121, 156, 152, 114, 130, 22, 98, 9, 99, 32, 0, 69, 0, 115, 0, 99, 0, 32, 0, 46, 149, 214, 83, 136, 109) ' ANSI: "΄ΣΖΑΔ»ΙΟµΔΘΞÒβΞ»ΦΓΡ΅ΤρÒ»ΦΦΡΥΙ«»ς°΄ Esc ΌόΘ΅Οϋ"
        Case cdUIT_frmColorDialog_picEyeDropper_ToolTipText ' English: "Choose a color from the screen"
            Text = StrFromArray(206, 78, 79, 92, 85, 94, 45, 78, 9, 144, 233, 98, 0, 78, 205, 121, 156, 152, 114, 130) ' ANSI: "΄ΣΖΑΔ»ΦΠΡ΅ΤρÒ»ΦΦΡΥΙ«"
        Case cdUIT_frmColorDialog_lblRed_Caption ' English: "Red:"
            Text = StrFromArray(162, 126, 114, 130, 58, 0) ' ANSI: "ΊμΙ«:"
        Case cdUIT_frmColorDialog_lblGreen_Caption ' English: "Green:"
            Text = StrFromArray(255, 126, 114, 130, 58, 0) ' ANSI: "ΒΜΙ«:"
        Case cdUIT_frmColorDialog_lblBlue_Caption ' English: "Blue:"
            Text = StrFromArray(221, 132, 114, 130, 58, 0) ' ANSI: "ΐ¶Ι«:"
        Case cdUIT_frmColorDialog_lblHex_Caption ' English: "Hex:"
            Text = StrFromArray(65, 83, 109, 81, 219, 143, 54, 82, 58, 0) ' ANSI: "Κ®Αω½ψΦΖ:"
        Case cdUIT_frmColorDialog_lblHue_Caption ' English: "Hue:"
            Text = StrFromArray(114, 130, 3, 140, 58, 0) ' ANSI: "Ι«µχ:"
        Case cdUIT_frmColorDialog_lblSaturation_Caption ' English: "Sat.:"
            Text = StrFromArray(113, 153, 140, 84, 166, 94, 58, 0) ' ANSI: "±¥ΊΝ¶Θ:"
        Case cdUIT_frmColorDialog_Luminance_Caption ' English: "Lum.:"
            Text = StrFromArray(174, 78, 166, 94, 58, 0) ' ANSI: "ΑΑ¶Θ:"
        Case cdUIT_frmColorDialog_Value_Caption ' English: "Value:"
            Text = StrFromArray(60, 80, 58, 0) ' ANSI: "Φµ:"
        Case cdUIT_frmColorDialog_lblColorSystem_Caption ' English: "Mode:"
            Text = StrFromArray(33, 106, 15, 95, 58, 0) ' ANSI: "Δ£Κ½:"
        Case cdUIT_frmColorDialog_lblPalette_Caption ' English: "Palette:"
            Text = StrFromArray(3, 140, 114, 130, 127, 103, 58, 0) ' ANSI: "µχΙ«°ε:"
        Case cdUIT_frmColorDialog_cboPalette_ListItem1 ' English: "Wheel, fixed"
            Text = StrFromArray(216, 118, 44, 0, 32, 0, 250, 86, 154, 91) ' ANSI: "ΕΜ, ΉΜ¶¨"
        Case cdUIT_frmColorDialog_cboPalette_ListItem2 ' English: "Box, fixed"
            Text = StrFromArray(70, 104, 44, 0, 32, 0, 250, 86, 154, 91) ' ANSI: "Ώς, ΉΜ¶¨"
        Case cdUIT_frmColorDialog_cboPalette_ListItem3 ' English: "Wheel, dynamic"
            Text = StrFromArray(216, 118, 44, 0, 32, 0, 168, 82, 1, 96, 132, 118) ' ANSI: "ΕΜ, ¶―Μ¬µΔ"
        Case cdUIT_frmColorDialog_cboPalette_ListItem4 ' English: "Box, dynamic"
            Text = StrFromArray(70, 104, 44, 0, 32, 0, 168, 82, 1, 96, 132, 118) ' ANSI: "Ώς, ¶―Μ¬µΔ"
        Case cdUIT_frmColorDialog_InvalidColorMessage ' English: "The color is not valid."
            Text = StrFromArray(156, 152, 114, 130, 224, 101, 72, 101) ' ANSI: "ΡΥΙ«ΞήΠ§"
        Case cdUIT_frmColorDialog_ParameterFullName_Hue ' English: "Hue"
            Text = StrFromArray(114, 130, 3, 140) ' ANSI: "Ι«µχ"
        Case cdUIT_frmColorDialog_ParameterFullName_Luminance ' English: "Luminance"
            Text = StrFromArray(174, 78, 166, 94) ' ANSI: "ΑΑ¶Θ"
        ...
        Case cdUIT_frmColorDialog_ParameterFullName_Value ' English: "Value"
            Text = StrFromArray(60, 80) ' ANSI: "Φµ"
        Case cdUIT_frmColorDialog_OK ' English: "OK"
            Text = StrFromArray(110, 120, 154, 91) ' ANSI: "Θ·¶¨"
        Case cdUIT_frmColorDialog_Cancel ' English: "Cancel"
            Text = StrFromArray(214, 83, 136, 109) ' ANSI: "Θ΅Οϋ"
        Case cdUIT_frmColorDialog_Close ' English: "Close"
            Text = StrFromArray(115, 81, 237, 149) ' ANSI: "ΉΨ±Υ"
    End Select
End Sub
...
Private Sub Do_GREEK(ByRef TextID As Long, ByRef Text As String)
    ...
    Select Case TextID
        Case cdUIT_frmColorDialog_Form_Caption ' English: "Color selection"
            Text = StrFromArray(149, 3, 192, 3, 185, 3, 187, 3, 191, 3, 179, 3, 174, 3, 194, 3, 32, 0, 167, 3, 193, 3, 201, 3, 188, 3, 172, 3, 196, 3, 201, 3, 189, 3) ' ANSI: "Επιλογής Χρωμάτων"
        Case cdUIT_ColorSelector_chkFixedPalette_Caption ' English: "Fixed"
            Text = StrFromArray(163, 3, 196, 3, 177, 3, 184, 3, 181, 3, 193, 3, 204, 3) ' ANSI: "Σταθερό"
        Case cdUIT_ColorSelector_chkFixedPalette_ToolTipText ' English: "Reflects color changes visually in the palette or not"
            Text = StrFromArray(145, 3, 189, 3, 196, 3, 177, 3, 189, 3, 177, 3, 186, 3, 187, 3, 172, 3, 32, 0, 196, 3, 185, 3, 194, 3, 32, 0, 177, 3, 187, 3, 187, 3, 177, 3, 179, 3, 173, 3, 194, 3, 32, 0, 199, 3, 193, 3, 206, 3, 188, 3, 177, 3, 196, 3, 191, 3, 194, 3, 32, 0, 191, 3, 192, 3, 196, 3, 185, 3, 186, 3, 172, 3, 32, 0, 195, 3, 196, 3, 183, 3, 189, 3, 32, 0, 192, 3, 177, 3, 187, 3, 173, 3, 196, 3, 177, 3, 32, 0, 174, 3, 32, 0, 204, 3, 199, 3, 185, 3) ' ANSI: "Αντανακλά τις αλλαγές χρώματος οπτικά στην παλέτα ή όχι"
        Case cdUIT_ColorSelector_cboSliderParameter_ToolTipText ' English: "Slider control parameter"
            Text = StrFromArray(160, 3, 177, 3, 193, 3, 172, 3, 188, 3, 181, 3, 196, 3, 193, 3, 191, 3, 194, 3, 32, 0, 195, 3, 196, 3, 191, 3, 185, 3, 199, 3, 181, 3, 175, 3, 191, 3, 32, 0, 181, 3, 187, 3, 173, 3, 179, 3, 199, 3, 191, 3, 197, 3, 32, 0, 193, 3, 197, 3, 184, 3, 188, 3, 185, 3, 195, 3, 196, 3, 185, 3, 186, 3, 191, 3, 205, 3) ' ANSI: "Παράμετρος στοιχείο ελέγχου ρυθμιστικού"
        Case cdUIT_ColorSelector_lblMode_Caption ' English: "Mode:"
            Text = StrFromArray(164, 3, 205, 3, 192, 3, 191, 3, 194, 3, 58, 0) ' ANSI: "Τύπος:"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Hue ' English: "Hue"
            Text = StrFromArray(145, 3, 192, 3, 191, 3, 199, 3, 46, 0) ' ANSI: "Αποχ."
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Luminance ' English: "Lum."
            Text = StrFromArray(166, 3, 201, 3, 196, 3, 46, 0) ' ANSI: "Φωτ."
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Value ' English: "Value"
            Text = StrFromArray(145, 3, 190, 3, 175, 3, 177, 3) ' ANSI: "Αξία"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Saturation ' English: "Sat."
            Text = StrFromArray(154, 3, 191, 3, 193, 3, 46, 0) ' ANSI: "Κορ."
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Red ' English: "Red"
            Text = StrFromArray(154, 3, 204, 3, 186, 3, 186, 3, 46, 0) ' ANSI: "Κόκκ."
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Green ' English: "Green"
            Text = StrFromArray(160, 3, 193, 3, 172, 3, 195, 3, 46, 0) ' ANSI: "Πράσ."
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Blue ' English: "Blue"
            Text = StrFromArray(156, 3, 192, 3, 187, 3, 181, 3) ' ANSI: "Μπλε"
        Case cdUIT_ColorSelector_cboColorSystem_ListItem_HSV ' English: "HSV"
            Text = "HSV"
        Case cdUIT_ColorSelector_cboColorSystem_ListItem_HSL ' English: "HSL"
            Text = "HSL"
        Case cdUIT_frmColorDialog_lblBasicColors_Caption ' English: "Basic colors:"
            Text = StrFromArray(146, 3, 177, 3, 195, 3, 185, 3, 186, 3, 172, 3, 32, 0, 199, 3, 193, 3, 206, 3, 188, 3, 177, 3, 196, 3, 177, 3, 58, 0) ' ANSI: "Βασικά χρώματα:"
        Case cdUIT_frmColorDialog_lblRecent_Caption ' English: "Recent:"
            Text = StrFromArray(160, 3, 193, 3, 204, 3, 195, 3, 198, 3, 177, 3, 196, 3, 177, 3, 58, 0) ' ANSI: "Πρόσφατα:"
        Case cdUIT_frmColorDialog_Color_Caption ' English: "color"
            Text = StrFromArray(199, 3, 193, 3, 206, 3, 188, 3, 177, 3) ' ANSI: "χρώμα"
        Case cdUIT_frmColorDialog_ColorNew_Caption ' English: "new"
            Text = StrFromArray(189, 3, 173, 3, 191, 3) ' ANSI: "νέο"
        Case cdUIT_frmColorDialog_ColorPrevious_Caption ' English: "previous"
            Text = StrFromArray(192, 3, 193, 3, 191, 3, 183, 3, 179, 3, 191, 3, 205, 3, 188, 3, 181, 3, 189, 3, 191, 3) ' ANSI: "προηγούμενο"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipStart ' English: "Hold down the Control key to navigate"
            Text = StrFromArray(154, 3, 193, 3, 177, 3, 196, 3, 174, 3, 195, 3, 196, 3, 181, 3, 32, 0, 192, 3, 177, 3, 196, 3, 183, 3, 188, 3, 173, 3, 189, 3, 191, 3, 32, 0, 196, 3, 191, 3, 32, 0, 192, 3, 187, 3, 174, 3, 186, 3, 196, 3, 193, 3, 191, 3, 32, 0, 67, 0, 111, 0, 110, 0, 116, 0, 114, 0, 111, 0, 108, 0, 32, 0, 179, 3, 185, 3, 177, 3, 32, 0, 177, 3, 187, 3, 187, 3, 177, 3, 179, 3, 174, 3) ' ANSI: "Κρατήστε πατημένο το πλήκτρο Control για αλλαγή"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipEnd ' English: "with the mouse wheel, press Shift key to go slowly"
            Text = StrFromArray(188, 3, 181, 3, 32, 0, 196, 3, 191, 3, 189, 3, 32, 0, 196, 3, 193, 3, 191, 3, 199, 3, 204, 3, 32, 0, 196, 3, 191, 3, 197, 3, 32, 0, 192, 3, 191, 3, 189, 3, 196, 3, 185, 3, 186, 3, 185, 3, 191, 3, 205, 3, 44, 0, 32, 0, 192, 3, 177, 3, 196, 3, 174, 3, 195, 3, 196, 3, 181, 3, 32, 0, 196, 3, 191, 3, 32, 0, 192, 3, 187, 3, 174, 3, 186, 3, 196, 3, 193, 3, 191, 3, 32, 0, 83, 0, 104, 0, 105, 0, 102, 0, 116, 0, 32, 0, 179, 3, 185, 3, 177, 3, 32, 0, 189, 3, 177, 3, 32, 0, 192, 3, 193, 3, 191, 3, 199, 3, 201, 3, 193, 3, 174, 3, 195, 3, 181, 3, 196, 3, 181, 3, 32, 0, 177, 3, 193, 3, 179, 3, 172, 3) ' ANSI: "με τον τροχό του ποντικιού, πατήστε το πλήκτρο Shift για να προχωρήσετε αργά"
        Case cdUIT_frmColorDialog_EyeDropper_ToolTip ' English: "Choose a color from anywhere on the screen or press the Escape key to cancel"
            Text = StrFromArray(149, 3, 192, 3, 185, 3, 187, 3, 173, 3, 190, 3, 196, 3, 181, 3, 32, 0, 173, 3, 189, 3, 177, 3, 32, 0, 199, 3, 193, 3, 206, 3, 188, 3, 177, 3, 32, 0, 177, 3, 192, 3, 204, 3, 32, 0, 191, 3, 192, 3, 191, 3, 197, 3, 180, 3, 174, 3, 192, 3, 191, 3, 196, 3, 181, 3, 32, 0, 195, 3, 196, 3, 183, 3, 189, 3, 32, 0, 191, 3, 184, 3, 204, 3, 189, 3, 183, 3, 32, 0, 174, 3, 32, 0, 192, 3, 177, 3, 196, 3, 174, 3, 195, 3, 196, 3, 181, 3, 32, 0, 196, 3, 191, 3, 32, 0, 192, 3, 187, 3, 174, 3, 186, 3, 196, 3, 193, 3, 191, 3, 32, 0, 69, 0, 115, 0, 99, 0, 97, 0, 112, 0, 101, 0, 32, 0, 179, 3, 185, 3, 177, 3, 32, 0, 177, 3, 186, 3, 205, 3, 193, 3, 201, 3, 195, 3, 183, 3) ' ANSI: "Επιλέξτε ένα χρώμα από οπουδήποτε στην οθόνη ή πατήστε το πλήκτρο Escape για ακύρωση"
        Case cdUIT_frmColorDialog_picEyeDropper_ToolTipText ' English: "Choose a color from the screen"
            Text = StrFromArray(149, 3, 192, 3, 185, 3, 187, 3, 173, 3, 190, 3, 196, 3, 181, 3, 32, 0, 173, 3, 189, 3, 177, 3, 32, 0, 199, 3, 193, 3, 206, 3, 188, 3, 177, 3, 32, 0, 177, 3, 192, 3, 204, 3, 32, 0, 196, 3, 183, 3, 189, 3, 32, 0, 191, 3, 184, 3, 204, 3, 189, 3, 183, 3) ' ANSI: "Επιλέξτε ένα χρώμα από την οθόνη"
        Case cdUIT_frmColorDialog_lblRed_Caption ' English: "Red:"
            Text = StrFromArray(154, 3, 204, 3, 186, 3, 186, 3, 185, 3, 189, 3, 191, 3, 58, 0) ' ANSI: "Κόκκινο:"
        Case cdUIT_frmColorDialog_lblGreen_Caption ' English: "Green:"
            Text = StrFromArray(160, 3, 193, 3, 172, 3, 195, 3, 185, 3, 189, 3, 191, 3, 58, 0) ' ANSI: "Πράσινο:"
        Case cdUIT_frmColorDialog_lblBlue_Caption ' English: "Blue:"
            Text = StrFromArray(156, 3, 192, 3, 187, 3, 181, 3, 58, 0) ' ANSI: "Μπλε:"
        Case cdUIT_frmColorDialog_lblHex_Caption ' English: "Hex:"
            Text = "Hex:"
        Case cdUIT_frmColorDialog_lblHue_Caption ' English: "Hue:"
            Text = StrFromArray(145, 3, 192, 3, 191, 3, 199, 3, 46, 0, 58, 0) ' ANSI: "Αποχ.:"
        Case cdUIT_frmColorDialog_lblSaturation_Caption ' English: "Sat.:"
            Text = StrFromArray(154, 3, 191, 3, 193, 3, 46, 0, 58, 0) ' ANSI: "Κορ.:"
        Case cdUIT_frmColorDialog_Luminance_Caption ' English: "Lum.:"
            Text = StrFromArray(166, 3, 201, 3, 196, 3, 46, 0, 58, 0) ' ANSI: "Φωτ.:"
        Case cdUIT_frmColorDialog_Value_Caption ' English: "Value:"
            Text = StrFromArray(145, 3, 190, 3, 175, 3, 177, 3, 58, 0) ' ANSI: "Αξία:"
        Case cdUIT_frmColorDialog_lblColorSystem_Caption ' English: "Mode:"
            Text = StrFromArray(164, 3, 205, 3, 192, 3, 191, 3, 194, 3, 58, 0) ' ANSI: "Τύπος:"
        Case cdUIT_frmColorDialog_lblPalette_Caption ' English: "Palette:"
            Text = StrFromArray(160, 3, 177, 3, 187, 3, 173, 3, 196, 3, 177, 3, 58, 0) ' ANSI: "Παλέτα:"
        Case cdUIT_frmColorDialog_cboPalette_ListItem1 ' English: "Wheel, fixed"
            Text = StrFromArray(164, 3, 193, 3, 191, 3, 199, 3, 204, 3, 194, 3, 44, 0, 32, 0, 195, 3, 196, 3, 177, 3, 184, 3, 181, 3, 193, 3, 204, 3, 194, 3) ' ANSI: "Τροχός, σταθερός"
        Case cdUIT_frmColorDialog_cboPalette_ListItem2 ' English: "Box, fixed"
            Text = StrFromArray(160, 3, 187, 3, 177, 3, 175, 3, 195, 3, 185, 3, 191, 3, 44, 0, 32, 0, 195, 3, 196, 3, 177, 3, 184, 3, 181, 3, 193, 3, 204, 3) ' ANSI: "Πλαίσιο, σταθερό"
        Case cdUIT_frmColorDialog_cboPalette_ListItem3 ' English: "Wheel, dynamic"
            Text = StrFromArray(164, 3, 193, 3, 191, 3, 199, 3, 204, 3, 194, 3, 44, 0, 32, 0, 180, 3, 197, 3, 189, 3, 177, 3, 188, 3, 185, 3, 186, 3, 204, 3, 194, 3) ' ANSI: "Τροχός, δυναμικός"
        Case cdUIT_frmColorDialog_cboPalette_ListItem4 ' English: "Box, dynamic"
            Text = StrFromArray(160, 3, 187, 3, 177, 3, 175, 3, 195, 3, 185, 3, 191, 3, 44, 0, 32, 0, 180, 3, 197, 3, 189, 3, 177, 3, 188, 3, 185, 3, 186, 3, 204, 3) ' ANSI: "Πλαίσιο, δυναμικό"
        Case cdUIT_frmColorDialog_InvalidColorMessage ' English: "The color is not valid."
            Text = StrFromArray(164, 3, 191, 3, 32, 0, 199, 3, 193, 3, 206, 3, 188, 3, 177, 3, 32, 0, 180, 3, 181, 3, 189, 3, 32, 0, 181, 3, 175, 3, 189, 3, 177, 3, 185, 3, 32, 0, 173, 3, 179, 3, 186, 3, 197, 3, 193, 3, 191, 3, 46, 0) ' ANSI: "Το χρώμα δεν είναι έγκυρο."
        Case cdUIT_frmColorDialog_ParameterFullName_Hue ' English: "Hue"
            Text = StrFromArray(145, 3, 192, 3, 204, 3, 199, 3, 193, 3, 201, 3, 195, 3, 183, 3) ' ANSI: "Απόχρωση"
        Case cdUIT_frmColorDialog_ParameterFullName_Luminance ' English: "Luminance"
            Text = StrFromArray(166, 3, 201, 3, 196, 3, 181, 3, 185, 3, 189, 3, 204, 3, 196, 3, 183, 3, 196, 3, 177, 3) ' ANSI: "Φωτεινότητα"
        Case cdUIT_frmColorDialog_ParameterFullName_Saturation ' English: "Saturation"
            Text = StrFromArray(154, 3, 191, 3, 193, 3, 181, 3, 195, 3, 188, 3, 204, 3, 194, 3) ' ANSI: "Κορεσμός"
        Case cdUIT_frmColorDialog_ParameterFullName_Red ' English: "Red"
            Text = StrFromArray(154, 3, 204, 3, 186, 3, 186, 3, 185, 3, 189, 3, 191, 3) ' ANSI: "Κόκκινο"
        Case cdUIT_frmColorDialog_ParameterFullName_Green ' English: "Green"
            Text = StrFromArray(160, 3, 193, 3, 172, 3, 195, 3, 185, 3, 189, 3, 191, 3) ' ANSI: "Πράσινο"
        Case cdUIT_frmColorDialog_ParameterFullName_Blue ' English: "Blue"
            Text = StrFromArray(156, 3, 192, 3, 187, 3, 181, 3) ' ANSI: "Μπλε"
        Case cdUIT_frmColorDialog_ParameterFullName_Value ' English: "Value"
            Text = StrFromArray(145, 3, 190, 3, 175, 3, 177, 3, 58, 0) ' ANSI: "Αξία:"
        Case cdUIT_frmColorDialog_OK ' English: "OK"
            Text = "OK"
        Case cdUIT_frmColorDialog_Cancel ' English: "Cancel"
            Text = StrFromArray(134, 3, 186, 3, 197, 3, 193, 3, 191, 3) ' ANSI: "Άκυρο"
        Case cdUIT_frmColorDialog_Close ' English: "Close"
            Text = StrFromArray(154, 3, 187, 3, 181, 3, 175, 3, 195, 3, 185, 3, 188, 3, 191, 3) ' ANSI: "Κλείσιμο"
    End Select
End Sub
