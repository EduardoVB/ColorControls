...
Private Sub Do_RUSSIAN(ByRef TextID As Long, ByRef Text As String)
    ...
    Select Case TextID
        Case cdUIT_frmColorDialog_Form_Caption ' English: "Color selection"
            Text = StrFromArray(18, 4, 75, 4, 49, 4, 62, 4, 64, 4, 32, 0, 70, 4, 50, 4, 53, 4, 66, 4, 48, 4) ' ANSI: "Âûáîð öâåòà"
        Case cdUIT_ColorSelector_chkFixedPalette_Caption ' English: "Fixed"
            Text = StrFromArray(36, 4, 56, 4, 58, 4, 65, 4, 56, 4, 64, 4, 46, 0) ' ANSI: "Ôèêñèð."
        Case cdUIT_ColorSelector_chkFixedPalette_ToolTipText ' English: "Reflects color changes visually in the palette or not"
            Text = StrFromArray(30, 4, 66, 4, 64, 4, 48, 4, 54, 4, 48, 4, 53, 4, 66, 4, 32, 0, 56, 4, 55, 4, 60, 4, 53, 4, 61, 4, 53, 4, 61, 4, 56, 4, 53, 4, 32, 0, 70, 4, 50, 4, 53, 4, 66, 4, 48, 4, 32, 0, 50, 4, 56, 4, 55, 4, 67, 4, 48, 4, 59, 4, 76, 4, 61, 4, 62, 4, 32, 0, 50, 4, 32, 0, 63, 4, 48, 4, 59, 4, 56, 4, 66, 4, 64, 4, 53, 4, 32, 0, 56, 4, 59, 4, 56, 4, 32, 0, 61, 4, 53, 4, 66, 4) ' ANSI: "Îòðàæàåò èçìåíåíèå öâåòà âèçóàëüíî â ïàëèòðå èëè íåò"
        Case cdUIT_ColorSelector_cboSliderParameter_ToolTipText ' English: "Slider control parameter"
            Text = StrFromArray(31, 4, 48, 4, 64, 4, 48, 4, 60, 4, 53, 4, 66, 4, 64, 4, 32, 0, 67, 4, 63, 4, 64, 4, 48, 4, 50, 4, 59, 4, 53, 4, 61, 4, 56, 4, 79, 4, 32, 0, 63, 4, 62, 4, 59, 4, 55, 4, 67, 4, 61, 4, 58, 4, 62, 4, 60, 4) ' ANSI: "Ïàðàìåòð óïðàâëåíèÿ ïîëçóíêîì"
        Case cdUIT_ColorSelector_lblMode_Caption ' English: "Mode:"
            Text = StrFromArray(32, 4, 53, 4, 54, 4, 56, 4, 60, 4, 58, 0) ' ANSI: "Ðåæèì:"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Hue ' English: "Hue"
            Text = StrFromArray(30, 4, 66, 4, 66, 4, 53, 4, 61, 4, 62, 4, 58, 4) ' ANSI: "Îòòåíîê"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Luminance ' English: "Lum."
            Text = StrFromArray(47, 4, 64, 4, 58, 4, 62, 4, 65, 4, 66, 4, 76, 4) ' ANSI: "ßðêîñòü"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Value ' English: "Value"
            Text = StrFromArray(23, 4, 61, 4, 48, 4, 71, 4, 53, 4, 61, 4, 56, 4, 53, 4) ' ANSI: "Çíà÷åíèå"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Saturation ' English: "Sat."
            'Text = StrFromArray(29, 4, 48, 4, 65, 4, 75, 4, 73, 4, 53, 4, 61, 4, 56, 4, 53, 4) ' ANSI: "Íàñûùåíèå"
            Text = StrFromArray(61, 4, 48, 4, 65, 4, 75, 4, 73, 4, 46, 0) ' ANSI: "íàñûù:"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Red ' English: "Red"
            Text = StrFromArray(26, 4, 64, 4, 48, 4, 65, 4, 61, 4, 75, 4, 57, 4) ' ANSI: "Êðàñíûé"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Green ' English: "Green"
            Text = StrFromArray(23, 4, 53, 4, 59, 4, 53, 4, 61, 4, 75, 4, 57, 4) ' ANSI: "Çåëåíûé"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Blue ' English: "Blue"
            Text = StrFromArray(33, 4, 56, 4, 61, 4, 56, 4, 57, 4) ' ANSI: "Ñèíèé"
        Case cdUIT_ColorSelector_cboColorSystem_ListItem_HSV ' English: "HSV"
            Text = "HSV"
        Case cdUIT_ColorSelector_cboColorSystem_ListItem_HSL ' English: "HSL"
            Text = "HSL"
        Case cdUIT_frmColorDialog_lblBasicColors_Caption ' English: "Basic colors:"
            Text = StrFromArray(30, 4, 65, 4, 61, 4, 62, 4, 50, 4, 61, 4, 75, 4, 53, 4, 32, 0, 70, 4, 50, 4, 53, 4, 66, 4, 48, 4, 58, 0) ' ANSI: "Îñíîâíûå öâåòà:"
        Case cdUIT_frmColorDialog_lblRecent_Caption ' English: "Recent:"
            Text = StrFromArray(31, 4, 62, 4, 65, 4, 59, 4, 53, 4, 52, 4, 61, 4, 56, 4, 53, 4, 58, 0) ' ANSI: "Ïîñëåäíèå:"
        Case cdUIT_frmColorDialog_Color_Caption ' English: "color"
            Text = StrFromArray(70, 4, 50, 4, 53, 4, 66, 4) ' ANSI: "öâåò"
        Case cdUIT_frmColorDialog_ColorNew_Caption ' English: "new"
            Text = StrFromArray(61, 4, 62, 4, 50, 4, 75, 4, 57, 4) ' ANSI: "íîâûé"
        Case cdUIT_frmColorDialog_ColorPrevious_Caption ' English: "previous"
            Text = StrFromArray(63, 4, 64, 4, 53, 4, 52, 4, 75, 4, 52, 4, 67, 4, 73, 4, 56, 4, 57, 4) ' ANSI: "ïðåäûäóùèé"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipStart ' English: "Hold down the Control key to change"
            Text = StrFromArray(35, 4, 52, 4, 53, 4, 64, 4, 54, 4, 56, 4, 50, 4, 48, 4, 57, 4, 66, 4, 53, 4, 32, 0, 58, 4, 59, 4, 48, 4, 50, 4, 56, 4, 72, 4, 67, 4, 32, 0, 67, 0, 111, 0, 110, 0, 116, 0, 114, 0, 111, 0, 108, 0, 44, 0, 32, 0, 71, 4, 66, 4, 62, 4, 49, 4, 75, 4, 32, 0, 56, 4, 55, 4, 60, 4, 53, 4, 61, 4, 56, 4, 66, 4, 76, 4) ' ANSI: "Óäåðæèâàéòå êëàâèøó Control, ÷òîáû èçìåíèòü"
        Case cdUIT_frmColorDialog_MouseWheel_ToolTipEnd ' English: "with the mouse wheel, press Shift key to go slowly"
            Text = StrFromArray(65, 4, 32, 0, 58, 4, 62, 4, 59, 4, 53, 4, 65, 4, 56, 4, 58, 4, 62, 4, 60, 4, 32, 0, 60, 4, 75, 4, 72, 4, 56, 4, 44, 0, 32, 0, 61, 4, 48, 4, 54, 4, 60, 4, 56, 4, 66, 4, 53, 4, 32, 0, 58, 4, 59, 4, 48, 4, 50, 4, 56, 4, 72, 4, 67, 4, 32, 0, 83, 0, 104, 0, 105, 0, 102, 0, 116, 0, 44, 0, 32, 0, 71, 4, 66, 4, 62, 4, 49, 4, 75, 4, 32, 0, 52, 4, 50, 4, 56, 4, 51, 4, 48, 4, 66, 4, 76, 4, 65, 4, 79, 4, 32, 0, 60, 4, 53, 4, 52, 4, 59, 4, 53, 4, 61, 4, 61, 4, 62, 4) ' ANSI: "ñ êîëåñèêîì ìûøè, íàæìèòå êëàâèøó Shift, ÷òîáû äâèãàòüñÿ ìåäëåííî"
        Case cdUIT_frmColorDialog_EyeDropper_ToolTip ' English: "Choose a color from anywhere on the screen or press the Escape key to cancel"
            Text = StrFromArray(18, 4, 75, 4, 49, 4, 53, 4, 64, 4, 56, 4, 66, 4, 53, 4, 32, 0, 70, 4, 50, 4, 53, 4, 66, 4, 32, 0, 50, 4, 32, 0, 59, 4, 78, 4, 49, 4, 62, 4, 60, 4, 32, 0, 60, 4, 53, 4, 65, 4, 66, 4, 53, 4, 32, 0, 77, 4, 58, 4, 64, 4, 48, 4, 61, 4, 48, 4, 32, 0, 56, 4, 59, 4, 56, 4, 32, 0, 61, 4, 48, 4, 54, 4, 60, 4, 56, 4, 66, 4, 53, 4, 32, 0, 58, 4, 59, 4, 48, 4, 50, 4, 56, 4, 72, 4, 67, 4, 32, 0, 69, 0, 115, 0, 99, 0, 97, 0, 112, 0, 101, 0, 44, 0, 32, 0, 71, 4, 66, 4, 62, 4, 49, 4, 75, 4, 32, 0, 62, 4, 66, 4, 60, 4, 53, 4, 61, 4, 56, 4, 66, 4, 76, 4) ' ANSI: "Âûáåðèòå öâåò â ëþáîì ìåñòå ýêðàíà èëè íàæìèòå êëàâèøó Escape, ÷òîáû îòìåíèòü"
        Case cdUIT_frmColorDialog_picEyeDropper_ToolTipText ' English: "Choose a color from the screen"
            Text = StrFromArray(18, 4, 75, 4, 49, 4, 53, 4, 64, 4, 56, 4, 66, 4, 53, 4, 32, 0, 70, 4, 50, 4, 53, 4, 66, 4, 32, 0, 61, 4, 48, 4, 32, 0, 77, 4, 58, 4, 64, 4, 48, 4, 61, 4, 53, 4) ' ANSI: "Âûáåðèòå öâåò íà ýêðàíå"
        Case cdUIT_frmColorDialog_lblRed_Caption ' English: "Red:"
            Text = StrFromArray(26, 4, 64, 4, 48, 4, 65, 4, 61, 4, 75, 4, 57, 4, 58, 0) ' ANSI: "Êðàñíûé:"
        Case cdUIT_frmColorDialog_lblGreen_Caption ' English: "Green:"
            Text = StrFromArray(23, 4, 53, 4, 59, 4, 53, 4, 61, 4, 75, 4, 57, 4, 58, 0) ' ANSI: "Çåëåíûé:"
        Case cdUIT_frmColorDialog_lblBlue_Caption ' English: "Blue:"
            Text = StrFromArray(33, 4, 56, 4, 61, 4, 56, 4, 57, 4, 58, 0) ' ANSI: "Ñèíèé:"
        Case cdUIT_frmColorDialog_lblHex_Caption ' English: "Hex:"
            Text = StrFromArray(40, 4, 53, 4, 65, 4, 66, 4, 61, 4, 46, 0, 58, 0) ' ANSI: "Øåñòí.:"
        Case cdUIT_frmColorDialog_lblHue_Caption ' English: "Hue:"
            Text = StrFromArray(30, 4, 66, 4, 66, 4, 53, 4, 61, 4, 62, 4, 58, 4, 58, 0) ' ANSI: "Îòòåíîê:"
        Case cdUIT_frmColorDialog_lblSaturation_Caption ' English: "Sat.:"
            Text = StrFromArray(61, 4, 48, 4, 65, 4, 75, 4, 73, 4, 46, 0, 58, 0) ' ANSI: "íàñûù.:"
        Case cdUIT_frmColorDialog_Luminance_Caption ' English: "Lum.:"
            Text = StrFromArray(47, 4, 64, 4, 58, 4, 62, 4, 65, 4, 66, 4, 76, 4, 58, 0) ' ANSI: "ßðêîñòü:"
        Case cdUIT_frmColorDialog_Value_Caption ' English: "Value:"
            Text = StrFromArray(23, 4, 61, 4, 48, 4, 71, 4, 53, 4, 61, 4, 56, 4, 53, 4, 58, 0) ' ANSI: "Çíà÷åíèå:"
        Case cdUIT_frmColorDialog_lblColorSystem_Caption ' English: "Mode:"
            Text = StrFromArray(32, 4, 53, 4, 54, 4, 56, 4, 60, 4, 58, 0) ' ANSI: "Ðåæèì:"
        Case cdUIT_frmColorDialog_lblPalette_Caption ' English: "Palette:"
            Text = StrFromArray(31, 4, 48, 4, 59, 4, 56, 4, 66, 4, 64, 4, 48, 4, 58, 0) ' ANSI: "Ïàëèòðà:"
        Case cdUIT_frmColorDialog_cboPalette_ListItem1 ' English: "Wheel, fixed"
            Text = StrFromArray(26, 4, 64, 4, 67, 4, 51, 4, 44, 0, 32, 0, 68, 4, 56, 4, 58, 4, 65, 4, 56, 4, 64, 4, 62, 4, 50, 4, 48, 4, 61, 4, 61, 4, 75, 4, 57, 4) ' ANSI: "Êðóã, ôèêñèðîâàííûé"
        Case cdUIT_frmColorDialog_cboPalette_ListItem2 ' English: "Box, fixed"
            Text = StrFromArray(47, 4, 73, 4, 56, 4, 58, 4, 44, 0, 32, 0, 68, 4, 56, 4, 58, 4, 65, 4, 56, 4, 64, 4, 62, 4, 50, 4, 48, 4, 61, 4, 61, 4, 75, 4, 57, 4) ' ANSI: "ßùèê, ôèêñèðîâàííûé"
        Case cdUIT_frmColorDialog_cboPalette_ListItem3 ' English: "Wheel, dynamic"
            Text = StrFromArray(26, 4, 64, 4, 67, 4, 51, 4, 44, 0, 32, 0, 52, 4, 56, 4, 61, 4, 48, 4, 60, 4, 56, 4, 71, 4, 53, 4, 65, 4, 58, 4, 56, 4, 57, 4) ' ANSI: "Êðóã, äèíàìè÷åñêèé"
        Case cdUIT_frmColorDialog_cboPalette_ListItem4 ' English: "Box, dynamic"
            Text = StrFromArray(47, 4, 73, 4, 56, 4, 58, 4, 44, 0, 32, 0, 52, 4, 56, 4, 61, 4, 48, 4, 60, 4, 56, 4, 71, 4, 53, 4, 65, 4, 58, 4, 56, 4, 57, 4) ' ANSI: "ßùèê, äèíàìè÷åñêèé"
        Case cdUIT_frmColorDialog_InvalidColorMessage ' English: "The color is not valid."
            Text = StrFromArray(38, 4, 50, 4, 53, 4, 66, 4, 32, 0, 61, 4, 53, 4, 52, 4, 53, 4, 57, 4, 65, 4, 66, 4, 50, 4, 56, 4, 66, 4, 53, 4, 59, 4, 53, 4, 61, 4, 46, 0) ' ANSI: "Öâåò íåäåéñòâèòåëåí."
        Case cdUIT_frmColorDialog_ParameterFullName_Hue ' English: "Hue"
            Text = StrFromArray(30, 4, 66, 4, 66, 4, 53, 4, 61, 4, 62, 4, 58, 4) ' ANSI: "Îòòåíîê"
        Case cdUIT_frmColorDialog_ParameterFullName_Luminance ' English: "Luminance"
            Text = StrFromArray(47, 4, 64, 4, 58, 4, 62, 4, 65, 4, 66, 4, 76, 4) ' ANSI: "ßðêîñòü"
        Case cdUIT_frmColorDialog_ParameterFullName_Saturation ' English: "Saturation"
            Text = StrFromArray(29, 4, 48, 4, 65, 4, 75, 4, 73, 4, 53, 4, 61, 4, 61, 4, 62, 4, 65, 4, 66, 4, 76, 4) ' ANSI: "Íàñûùåííîñòü"
        Case cdUIT_frmColorDialog_ParameterFullName_Red ' English: "Red"
            Text = StrFromArray(26, 4, 64, 4, 48, 4, 65, 4, 61, 4, 75, 4, 57, 4) ' ANSI: "Êðàñíûé"
        Case cdUIT_frmColorDialog_ParameterFullName_Green ' English: "Green"
            Text = StrFromArray(23, 4, 53, 4, 59, 4, 53, 4, 61, 4, 75, 4, 57, 4) ' ANSI: "Çåëåíûé"
        ...
        Case cdUIT_frmColorDialog_OK ' English: "OK"
            Text = "OK"
        Case cdUIT_frmColorDialog_Cancel ' English: "Cancel"
            Text = StrFromArray(30, 4, 66, 4, 60, 4, 53, 4, 61, 4, 48, 4) ' ANSI: "Îòìåíà"
        Case cdUIT_frmColorDialog_Close ' English: "Close"
            Text = StrFromArray(23, 4, 48, 4, 58, 4, 64, 4, 75, 4, 66, 4, 76, 4) ' ANSI: "Çàêðûòü"
    End Select
End Sub
...
Private Sub Do_PORTUGUESE(ByRef TextID As Long, ByRef Text As String)
    ...
    Select Case TextID
        ...
        Case cdUIT_ColorSelector_chkFixedPalette_Caption ' English: "Fixed"
            Text = "Fixa"
        Case cdUIT_ColorSelector_chkFixedPalette_ToolTipText ' English: "Reflects color changes visually in the palette or not"
            Text = "Reflete as mudanças de cor visualmente na paleta ou não"
        Case cdUIT_ColorSelector_cboSliderParameter_ToolTipText ' English: "Slider control parameter"
            If mUISubLanguage = SUBLANG_PORTUGUESE_BRAZILIAN Then
                Text = "Parâmetro de controle deslizante"
            Else
                Text = "Parâmetro de controlo de deslize"
            End If
        Case cdUIT_ColorSelector_lblMode_Caption ' English: "Mode:"
            Text = "Modo:"
        Case cdUIT_ColorSelector_cboSliderParameter_ListItem_Hue ' English: "Hue"
